      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <p className="font-heading italic text-2xl md:text-3xl text-nature-dark/80">
            "Ils ont voulu me faire confiance, ils n'auraient pas dû... <br/>
            <span className="text-base not-italic mt-2 block text-nature-muted">(Je plaisante, bien sûr)</span>"
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-12 mt-12 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
            {partners.map((partner, index) => (
              <div key={index} className="flex items-center justify-center p-4 border border-nature-dark/10 rounded bg-white/50">
                {/* Using a placeholder text if image fails or for simplicity */}
                <span className="font-display font-bold text-nature-dark text-lg">{partner.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2 space-y-8">
                ...
                <p className="text-lg leading-relaxed text-nature-text">
                    Passionné par la complexité du vivant, je suis diplômé en <strong>Gestion des Milieux Naturels et de la Faune (GMNF)</strong>. 
                ...
                <div className="space-y-6">
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h3 className="font-heading font-bold text-xl text-nature-dark">Médiation Scientifique</h3>
                            <p className="text-nature-muted">Vulgariser sans simplifier, pour rendre la nature accessible à tous.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h3 className="font-heading font-bold text-xl text-nature-dark">Montagne & Randonnée</h3>
                            <p className="text-nature-muted">Encadrement sécurisé et découverte des écosystèmes d'altitude.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h3 className="font-heading font-bold text-xl text-nature-dark">Gestion de projet</h3>
                            <p className="text-nature-muted">Conception d'outils pédagogiques et plans de gestion écologique.</p>
                        </div>
                    </div>
                </div>
            </div>

...
const Contact: React.FC = () => {
  return (
    <section
      className="bg-nature-dark text-nature-light py-24 relative overflow-hidden"
      id="contact"
    >
      {/* Background patterns */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8 mb-16">
          ...
          <p className="font-serif text-nature-light/80 text-xl md:text-2xl leading-relaxed">
            Une mission d'expertise, une animation pédagogique ou une escapade
            en montagne ? Contactez-moi directement pour discuter de vos
            besoins.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {/* Email Box */}
          <a
            href="mailto:contact@enzobagneris.fr"
            className="group relative bg-nature-light/5 border border-nature-light/10 p-10 rounded-2xl hover:bg-nature-light hover:text-nature-dark transition-all duration-300 overflow-hidden"
          >
            ...
            <p className="font-serif text-lg opacity-80 mb-1">
          ...
          >
            ...
            <p className="font-bold text-xl tracking-wide">07 69 64 14 81</p>
          </a>
        </div>
        ...
        <div className="mt-16 pt-16 border-t border-nature-light/10 flex flex-col md:flex-row justify-between items-center gap-8 max-w-4xl mx-auto text-nature-light/60">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif text-lg">
              Basé à Pau, dans les Pyrénées, mobile en Nouvelle-Aquitaine et
              Occitanie
            </span>
          </div>
          ...
          <div className="flex gap-4">
            <a
              href="https://www.instagram.com/enphotto/"
              className="p-3 border border-nature-light/20 rounded-full hover:bg-nature-light hover:text-nature-dark transition-all"
            >
              <Instagram size={20} />
            </a>
            <a
              href="https://www.linkedin.com/in/enzo-bagneris/"
              className="p-3 border border-nature-light/20 rounded-full hover:bg-nature-light hover:text-nature-dark transition-all"
            >
              <Linkedin size={20} />
            </a>

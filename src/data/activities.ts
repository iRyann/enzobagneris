...
export const activities: Activity[] = [
  {
    ...
    image: {
      url: '/assets/images/presentation/home/service-animation.jpg',
    ...
    modules: {
      ...
      'Entreprises (RSE)': {
        ...
        keyLearning: ['Impact RSE concret', 'Gestion de projet manuel', 'Sensibilisation locale'],
      },
      'Grand Public': {
        id: 'gp-1',
  ...
  },
  {
    ...
    modules: {
      ...
      'Entreprises (RSE)': {
        ...
        duration: 'Demi-journée',
        keyLearning: ['Leadership partagé', 'Gestion du temps', 'Stratégie collective'],
      },
      'Grand Public': {
        id: 'gp-2',
      ...
      'Projets tutorés': {
        ...
        duration: 'Semestre',
        keyLearning: ['Cartographie', 'Gestion de projet', 'Médiation territoriale'],
      },
    },
  },
];

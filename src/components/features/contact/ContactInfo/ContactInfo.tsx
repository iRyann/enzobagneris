...
/**
 * Section de contact avec informations principales.
 */
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="font-bold text-xl tracking-wide">{author.email}</p>
          </a>

          <a
            href={`tel:${author.phoneCompact}`}
            className="group relative bg-nature-light/5 border border-nature-light/10 p-10 rounded-2xl hover:bg-nature-light hover:text-nature-dark transition-all duration-300 overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-6 opacity-0 group-hover:opacity-100 transition-opacity transform translate-x-4 group-hover:translate-x-0">
              <ArrowRight className="w-8 h-8" />
            ...
            <p className="font-bold text-xl tracking-wide">{author.phone}</p>
          </a>
        </div>
        ...
        <div className="mt-16 pt-16 border-t border-nature-light/10 flex flex-col md:flex-row justify-between items-center gap-8 max-w-4xl mx-auto text-nature-light/60">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif text-lg">
              Basé dans les Pyrénées, mobile en France
            </span>
          </div>

...
export function AboutSection() {
  const skills: SkillItem[] = [
    {
      icon: Sprout,
      label: "Médiation Scientifique",
      className: "text-nature-dark",
    },
    {
      icon: Mountain,
      label: "Encadrement Montagne",
      className: "text-nature-accent",
    },
    {
      icon: Award,
      label: "Gestion de Projets Nature",
      className: "text-nature-soft",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1 relative">
            <div className="w-full aspect-square rounded-full overflow-hidden border-8 border-nature-soft shadow-xl">
              <img
                src="/assets/images/presentation/home/profile.jpeg"
          ...
          <div className="order-1 md:order-2 space-y-8">
            <div>
              <p className="font-heading italic text-xl text-nature-accent mb-2">
                Qui suis-je ?
              </p>
            ...
            <p className="text-lg leading-relaxed text-nature-text">
              Diplômé en{" "}
              <strong>Gestion des Milieux Naturels et de la Faune</strong> et{" "}
              <strong>Initiateur Montagnisme</strong>, je combine expertise
              technique et passion pour la transmission.
              <br />
              <br />
              Mon objectif ? Connecter le public au vivant à travers des
              expériences immersives et scientifiquement rigoureuses.
            </p>
